...
Version  : 49
Release  : 55
URL      : https://github.com/clearlinux/clr-avx-tools/archive/v49/clr-avx-tools-49.tar.gz
Source0  : https://github.com/clearlinux/clr-avx-tools/archive/v49/clr-avx-tools-49.tar.gz
...
%prep
%setup -q -n clr-avx-tools-49
cd %{_builddir}/clr-avx-tools-49
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674580704
