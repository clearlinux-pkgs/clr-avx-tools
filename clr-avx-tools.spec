...
Version  : 34
Release  : 37
URL      : https://github.com/clearlinux/clr-avx-tools/archive/v34/clr-avx-tools-34.tar.gz
Source0  : https://github.com/clearlinux/clr-avx-tools/archive/v34/clr-avx-tools-34.tar.gz
...
%prep
%setup -q -n clr-avx-tools-34
cd %{_builddir}/clr-avx-tools-34
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656085664
...
cp %{_builddir}/clr-avx-tools-34/COPYING %{buildroot}/usr/share/package-licenses/clr-avx-tools/04319952ed7b0f3b3a70ae4d5d9f954317b8f970
%make_install
