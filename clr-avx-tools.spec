...
Version  : 45
Release  : 50
URL      : https://github.com/clearlinux/clr-avx-tools/archive/v45/clr-avx-tools-45.tar.gz
Source0  : https://github.com/clearlinux/clr-avx-tools/archive/v45/clr-avx-tools-45.tar.gz
...
%prep
%setup -q -n clr-avx-tools-45
cd %{_builddir}/clr-avx-tools-45
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661194354
