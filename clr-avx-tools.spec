...
Version  : 42
Release  : 47
URL      : https://github.com/clearlinux/clr-avx-tools/archive/v41/clr-avx-tools-42.tar.gz
Source0  : https://github.com/clearlinux/clr-avx-tools/archive/v41/clr-avx-tools-42.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660331910
...
cp %{_builddir}/clr-avx-tools-41/COPYING %{buildroot}/usr/share/package-licenses/clr-avx-tools/04319952ed7b0f3b3a70ae4d5d9f954317b8f970
%make_install
