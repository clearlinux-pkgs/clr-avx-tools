...
Version  : 40
Release  : 43
URL      : https://github.com/clearlinux/clr-avx-tools/archive/v40/clr-avx-tools-40.tar.gz
Source0  : https://github.com/clearlinux/clr-avx-tools/archive/v40/clr-avx-tools-40.tar.gz
...
%prep
%setup -q -n clr-avx-tools-40
cd %{_builddir}/clr-avx-tools-40
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659996240
