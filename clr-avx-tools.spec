...
Version  : 39
Release  : 42
URL      : https://github.com/clearlinux/clr-avx-tools/archive/v39/clr-avx-tools-39.tar.gz
Source0  : https://github.com/clearlinux/clr-avx-tools/archive/v39/clr-avx-tools-39.tar.gz
...
%prep
%setup -q -n clr-avx-tools-39
cd %{_builddir}/clr-avx-tools-39
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659983076
