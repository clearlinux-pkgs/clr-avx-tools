...
Version  : 46
Release  : 51
URL      : https://github.com/clearlinux/clr-avx-tools/archive/v46/clr-avx-tools-46.tar.gz
Source0  : https://github.com/clearlinux/clr-avx-tools/archive/v46/clr-avx-tools-46.tar.gz
...
%prep
%setup -q -n clr-avx-tools-46
cd %{_builddir}/clr-avx-tools-46
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661200555
