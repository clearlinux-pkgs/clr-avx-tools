...
Version  : 48
Release  : 54
URL      : https://github.com/clearlinux/clr-avx-tools/archive/v48/clr-avx-tools-48.tar.gz
Source0  : https://github.com/clearlinux/clr-avx-tools/archive/v48/clr-avx-tools-48.tar.gz
...
%prep
%setup -q -n clr-avx-tools-48
cd %{_builddir}/clr-avx-tools-48
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664078436
