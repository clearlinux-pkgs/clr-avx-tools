...
Version  : 29
Release  : 32
URL      : https://github.com/clearlinux/clr-avx-tools/archive/v29/clr-avx-tools-29.tar.gz
Source0  : https://github.com/clearlinux/clr-avx-tools/archive/v29/clr-avx-tools-29.tar.gz
...
%prep
%setup -q -n clr-avx-tools-29
cd %{_builddir}/clr-avx-tools-29
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645028712
...
cp %{_builddir}/clr-avx-tools-29/COPYING %{buildroot}/usr/share/package-licenses/clr-avx-tools/04319952ed7b0f3b3a70ae4d5d9f954317b8f970
%make_install
