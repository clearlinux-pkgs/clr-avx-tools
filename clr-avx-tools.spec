...
Version  : 13
Release  : 15
URL      : https://github.com/clearlinux/clr-avx-tools/archive/v13/clr-avx-tools-13.tar.gz
Source0  : https://github.com/clearlinux/clr-avx-tools/archive/v13/clr-avx-tools-13.tar.gz
...
%prep
%setup -q -n clr-avx-tools-13
cd %{_builddir}/clr-avx-tools-13
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1633702436
...
cp %{_builddir}/clr-avx-tools-13/COPYING %{buildroot}/usr/share/package-licenses/clr-avx-tools/04319952ed7b0f3b3a70ae4d5d9f954317b8f970
%make_install
