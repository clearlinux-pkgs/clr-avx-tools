...
Source0  : https://github.com/clearlinux/clr-avx-tools/archive/v55/clr-avx-tools-55.tar.gz
...
%prep
%setup -q -n clr-avx-tools-55
cd %{_builddir}/clr-avx-tools-55
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706798322
