...
Version  : 15
Release  : 17
URL      : https://github.com/clearlinux/clr-avx-tools/archive/v15/clr-avx-tools-15.tar.gz
Source0  : https://github.com/clearlinux/clr-avx-tools/archive/v15/clr-avx-tools-15.tar.gz
...
%prep
%setup -q -n clr-avx-tools-15
cd %{_builddir}/clr-avx-tools-15
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1633703883
...
cp %{_builddir}/clr-avx-tools-15/COPYING %{buildroot}/usr/share/package-licenses/clr-avx-tools/04319952ed7b0f3b3a70ae4d5d9f954317b8f970
%make_install
