...
Version  : 25
Release  : 28
URL      : https://github.com/clearlinux/clr-avx-tools/archive/v25/clr-avx-tools-25.tar.gz
Source0  : https://github.com/clearlinux/clr-avx-tools/archive/v25/clr-avx-tools-25.tar.gz
...
%prep
%setup -q -n clr-avx-tools-25
cd %{_builddir}/clr-avx-tools-25
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642791154
...
cp %{_builddir}/clr-avx-tools-25/COPYING %{buildroot}/usr/share/package-licenses/clr-avx-tools/04319952ed7b0f3b3a70ae4d5d9f954317b8f970
%make_install
